...
baf_links <- tibble::tribble(
  ...
  'state',    c(2005:2012), 'cd', 2010, bafs['cd_109'],
  'national', c(2013:2014), 'cd', 2010, befs['cd_113'],
  'national', c(2015:2016), 'cd', 2010, befs['cd_114'],
  'national', c(2017:2018), 'cd', 2010, befs['cd_115'],
  'national', c(2019:2020), 'cd', 2010, befs['cd_116'],
  'state',    c(2021:2022), 'cd', 2020, bafs['cd_117'],
  'national', c(2023:2024), 'cd', 2020, befs['cd_118'],

  # state legislative districts
  'national', c(2012:2015), 'shd', 2010, befs['shd_2012'],
  'national', c(2016:2020), 'shd', 2010, befs['shd_2016'],
  'national', c(2021:2022), 'shd', 2020, befs['shd_2022'],

  'national', c(2012:2015), 'ssd', 2010, befs['ssd_2012'],
  'national', c(2016:2020), 'ssd', 2010, befs['ssd_2016'],
  'national', c(2021:2022), 'ssd', 2020, befs['ssd_2022'],

  # general bafs
  'state', c(2010:2019), 'etc', 2010, bafs['cd_109'],
  'state', c(2020:2029), 'etc', 2020, bafs['cd_117']
)
